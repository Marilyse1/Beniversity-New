...
<!-- Mirrored from layerdrops.com/oxpinshtml/main-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 09:18:43 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Accueil || Béniversity ||  </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                ...
                <div class="main-menu__wrapper">
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__right-bottom" style="background: #101a5f">
                                    ...
                                    <div class="main-menu__search-cat-btn-box">
                                        ...
                                        <div class="main-menu__btn-box" style="background: #ffd105" >
                                            <a href="donate-now.html" class="main-menu__btn" style="background: #ffd105"> <span
                                                    class="fa fa-heart" style="background: #ffd105"></span> Donate
                                                now</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="donation-carousel thm-owl__carousel owl-theme owl-carousel carousel-dot-style"
                    ...
                    <div class="item">
                        <div class="causes-one__single">
                            ...
                            <div class="causes-one__content">
                                <h3 class="causes-one__title"><a href="donation-details.html">Maecenas ut ligula ut nisi
                                        porta tempor ac</a>
                                </h3>
                                <p class="causes-one__text">There are many of lorem, but majori have
                                    suffered alteration in some form.</p>
                    ...
                    <div class="item">
                        <div class="causes-one__single">
                            ...
                            <div class="causes-one__content">
                                <h3 class="causes-one__title"><a href="donation-details.html">Phasellus suscipit est
                    ...
                    <div class="item">
                        <div class="causes-one__single">
                            ...
                            <div class="causes-one__content">
                                <h3 class="causes-one__title"><a href="donation-details.html">Sed malesuada nisl eget
                                        porta luctus</a>
                                </h3>
                                <p class="causes-one__text">There are many of lorem, but majori have
                                    suffered alteration in some form.</p>
        ...
        <!--Site Footer Start-->
        <footer class="site-footer" style="background: #101a5f">
            <div class="site-footer-bg" style="background-image: url(assets/images/logo.png);">
            </div>
            ...
            <div class="site-footer__bottom" style="background: #101a5f">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer__bottom-inner">
                                <p class="site-footer__bottom-text">© All Copyright 2023 by <a href="#">Beniversity.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="mobile-nav__wrapper" style="background: #101a5f">
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    <i class="fa fa-envelope"></i>
                    <a href="mailto:needhelp@packageName__.com">contact@beniversity.com</a>
                </li>
                <li>
...
<!-- Mirrored from layerdrops.com/oxpinshtml/main-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 09:20:48 GMT -->
</html>