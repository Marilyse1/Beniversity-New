                            ...
                            <div class="news-one__content-inner">
                                <div class="news-one__content">
                                    <ul class="list-unstyled news-one__meta">
                                        <li><a href="{{ route('blog-details') }}"><i class="far fa-user-circle"></i> Admin</a>
                                        </li>
                                        <li><a href="{{ route('blog-details') }}"><i class="fas fa-comments"></i> 2
                                                Comments</a>
                                        </li>
                                    </ul>
                                    <h3 class="news-one__title"><a href="{{ route('blog-details') }}">How does the
                                            malnutrition
                                            affect children?</a></h3>
                                </div>
                                <div class="news-one__bottom">
                                    <div class="news-one__read-more">
                                        <a href="{{ route('blog-details') }}"> <span class="icon-right-arrow"></span> Read
                                            More</a>
                                    </div>
                        ...
                        <div class="news-one__content-box">
                            <div class="news-one__content-inner">
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title"><a href="{{ route('blog-details') }}">Lorem Ipsum has been the
                        ...
                        <div class="news-one__content-box">
                            <div class="news-one__content-inner">
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title"><a href="{{ route('blog-details') }}">There are many
                        ...
                        <div class="news-one__content-box">
                            <div class="news-one__content-inner">
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title"><a href="{{ route('blog-details') }}">Lorem ipsum dolor sit
                        ...
                        <div class="news-one__content-box">
                            <div class="news-one__content-inner">
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title"><a href="{{ route('blog-details') }}">Aenean sollicitudin leo
                        ...
                        <div class="news-one__content-box">
                            <div class="news-one__content-inner">
                                <div class="news-one__content">
                                    ...
                                    <h3 class="news-one__title"><a href="{{ route('blog-details') }}">Donec a scelerisque
